...
export const Route = createFileRoute("/admin/referral")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pantau kode referral setiap pengguna MIFX dan jumlah orang yang berhasil mereka ajak." },
      { property: "og:title", content: "Manajemen Referral — MIFX Admin" },
      { property: "og:description", content: "Pantau kode referral setiap pengguna MIFX dan jumlah orang yang berhasil mereka ajak." },
