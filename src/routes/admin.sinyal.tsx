...
export const Route = createFileRoute("/admin/sinyal")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kelola sinyal trading yang tampil di beranda aplikasi MIFX." },
      { property: "og:title", content: "Admin Sinyal — MIFX" },
      { property: "og:description", content: "Kelola sinyal trading yang tampil di beranda aplikasi MIFX." },
